...
``` bash
TELEGRAM_TOKEN=5859273218:AAF-SLrEjtWx3ISBPpb3AwN1mg3ypPnqptw  # your bot's token
TELEGRAM_SUPPORT_CHAT_ID=-815422523  # chat_id where the bot will forward all incoming messages
